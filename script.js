document.addEventListener('DOMContentLoaded', function() {
    ...
    window.onload = function() {
        var played = false; // 오디오가 재생되었는지 확인하기 위한 플래그
    
        function playAllMusic() {
            if (!played) {
                document.getElementById('vcMusic').play();
                document.getElementById('flMusic').play();
                document.getElementById('ukuMusic').play();
                document.getElementById('djbMusic').play();
                document.getElementById('drMusic').play();
                document.getElementById('vnMusic').play();
                document.getElementById('trbMusic').play();
                document.getElementById('gtrMusic').play();
                document.getElementById('pfMusic').play();
                document.getElementById('cbMusic').play();
                document.getElementById('trpMusic').play();
                played = true; // 오디오가 재생되었음을 표시
            }
        }
    
        window.addEventListener('click', playAllMusic); // 윈도우의 첫 클릭에 반응
    };
